...
export const DEFAULT_PLAN_SEEDS: DefaultPlanSeed[] = [
  {
    ...
    features: [
      ...
      { sectionKey: SECTIONS.insights.key, sectionLabel: SECTIONS.insights.label, label: 'Time-per-question analytics',    valueType: FeatureValueType.CROSS,  included: false,      showOnCard: false, entitlementKey: 'TIME_PER_QUESTION',    sortOrder: 7 },
      { sectionKey: SECTIONS.insights.key, sectionLabel: SECTIONS.insights.label, label: 'Percentile by year/section',     valueType: FeatureValueType.CROSS,  included: false,      showOnCard: false, entitlementKey: 'PERCENTILE_BREAKDOWN', sortOrder: 8 },
      { sectionKey: SECTIONS.collab.key,   sectionLabel: SECTIONS.collab.label,   label: 'Study groups',                   valueType: FeatureValueType.NUMBER, value: '2',           showOnCard: true,  isComingSoon: true, entitlementKey: 'STUDY_GROUPS_MAX',  sortOrder: 9 },
      { sectionKey: SECTIONS.collab.key,   sectionLabel: SECTIONS.collab.label,   label: 'Quiz-from-friend challenges',    valueType: FeatureValueType.CROSS,  included: false,      showOnCard: false, isComingSoon: true, entitlementKey: 'FRIEND_CHALLENGES', sortOrder: 10 },
      { sectionKey: SECTIONS.collab.key,   sectionLabel: SECTIONS.collab.label,   label: 'Chat & live duels',              valueType: FeatureValueType.TEXT,   value: 'Read-only',   showOnCard: false, isComingSoon: true, entitlementKey: 'CHAT_DUELS',        sortOrder: 11 },
      { sectionKey: SECTIONS.support.key,  sectionLabel: SECTIONS.support.label,  label: 'Email support',                  valueType: FeatureValueType.TEXT,   value: '72-hour',     showOnCard: false, sortOrder: 12 },
      { sectionKey: SECTIONS.support.key,  sectionLabel: SECTIONS.support.label,  label: 'Early access to new features',   valueType: FeatureValueType.CROSS,  included: false,      showOnCard: false, entitlementKey: 'EARLY_ACCESS',         sortOrder: 13 },
    ],
  },
  {
    sortOrder: 1,
    ...
    features: [
      ...
      { sectionKey: SECTIONS.insights.key, sectionLabel: SECTIONS.insights.label, label: 'Weak-topic analytics',           valueType: FeatureValueType.CHECK,  showOnCard: true,  showInCompare: false, sortOrder: 8 },
      { sectionKey: SECTIONS.insights.key, sectionLabel: SECTIONS.insights.label, label: 'Time-per-question analytics',    valueType: FeatureValueType.CROSS,  included: false,      showOnCard: false, entitlementKey: 'TIME_PER_QUESTION',    sortOrder: 9 },
      { sectionKey: SECTIONS.insights.key, sectionLabel: SECTIONS.insights.label, label: 'Percentile by year/section',     valueType: FeatureValueType.CROSS,  included: false,      showOnCard: false, entitlementKey: 'PERCENTILE_BREAKDOWN', sortOrder: 10 },
      { sectionKey: SECTIONS.collab.key,   sectionLabel: SECTIONS.collab.label,   label: 'Study groups',                   valueType: FeatureValueType.NUMBER, value: '5',           showOnCard: true,  isComingSoon: true, entitlementKey: 'STUDY_GROUPS_MAX',  sortOrder: 11 },
      { sectionKey: SECTIONS.collab.key,   sectionLabel: SECTIONS.collab.label,   label: 'Quiz-from-friend challenges',    valueType: FeatureValueType.CHECK,  showOnCard: true,  isComingSoon: true, entitlementKey: 'FRIEND_CHALLENGES', sortOrder: 12 },
      { sectionKey: SECTIONS.collab.key,   sectionLabel: SECTIONS.collab.label,   label: 'Chat & live duels',              valueType: FeatureValueType.CHECK,  showOnCard: false, isComingSoon: true, entitlementKey: 'CHAT_DUELS',        sortOrder: 13 },
      { sectionKey: SECTIONS.support.key,  sectionLabel: SECTIONS.support.label,  label: 'Email support',                  valueType: FeatureValueType.TEXT,   value: '24-hour',     showOnCard: false, sortOrder: 14 },
      { sectionKey: SECTIONS.support.key,  sectionLabel: SECTIONS.support.label,  label: 'Early access to new features',   valueType: FeatureValueType.CROSS,  included: false,      showOnCard: false, entitlementKey: 'EARLY_ACCESS',         sortOrder: 15 },
    ],
  },
  {
    sortOrder: 2,
    ...
    features: [
      ...
      { sectionKey: SECTIONS.insights.key, sectionLabel: SECTIONS.insights.label, label: 'Advanced analytics — weak topics, time-per-Q, percentile breakdowns', valueType: FeatureValueType.CHECK, showOnCard: true, showInCompare: false, sortOrder: 9 },
      { sectionKey: SECTIONS.insights.key, sectionLabel: SECTIONS.insights.label, label: 'Time-per-question analytics',    valueType: FeatureValueType.CHECK,  showOnCard: false, entitlementKey: 'TIME_PER_QUESTION',    sortOrder: 10 },
      { sectionKey: SECTIONS.insights.key, sectionLabel: SECTIONS.insights.label, label: 'Percentile by year/section',     valueType: FeatureValueType.CHECK,  showOnCard: false, entitlementKey: 'PERCENTILE_BREAKDOWN', sortOrder: 11 },
      { sectionKey: SECTIONS.collab.key,   sectionLabel: SECTIONS.collab.label,   label: 'Study groups',                   valueType: FeatureValueType.TEXT,   value: 'Unlimited',   showOnCard: true,  isComingSoon: true, entitlementKey: 'STUDY_GROUPS_MAX',  sortOrder: 12 },
      { sectionKey: SECTIONS.collab.key,   sectionLabel: SECTIONS.collab.label,   label: 'Quiz-from-friend challenges',    valueType: FeatureValueType.CHECK,  showOnCard: false, isComingSoon: true, entitlementKey: 'FRIEND_CHALLENGES', sortOrder: 13 },
      ...
      { sectionKey: SECTIONS.support.key,  sectionLabel: SECTIONS.support.label,  label: 'Email support',                  valueType: FeatureValueType.TEXT,   value: 'Priority · 4-hour', showOnCard: false, sortOrder: 15 },
