...
export default function RRBrand({
  ...
  return (
    <Link to={to} className={`rr-brand ${className}`} style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none", color: "inherit" }}>
      <div className={`rr-mark ${size === "sm" ? "sm" : size === "lg" ? "lg" : ""}`}>
